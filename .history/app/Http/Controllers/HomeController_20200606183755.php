...
class HomeController extends Controller
{
    public function index(){
        $posters = DB::table('category')->join('posters', 'poster.id_category', '=', 'category.id')->join('users', 'users.id', '=', 'poster.id_creator')->get(['category.title as categorytitle', 'users.*', 'poster.*']);
