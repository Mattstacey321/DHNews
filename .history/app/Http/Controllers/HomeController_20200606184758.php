...
class HomeController extends Controller
{
    public function index(){
        $posters = DB::table('categories')->join('posters', 'posters.id_category', '=', 'category.id')->join('users', 'users.id', '=', 'posters.id_creator')->get(['category.title as categorytitle', 'users.*', 'posters.*']);
